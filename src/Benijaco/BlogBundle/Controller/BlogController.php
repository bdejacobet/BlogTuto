...
class BlogController extends Controller
{
    public function indexAction()
    {
        ...
        return $this->render('BenijacoBlogBundle:Blog:index.html.twig');
    }
    
    public function voirAction($id)
    {
        return $this->render('BenijacoBlogBundle:Blog:voir.html.twig', array('id' => $id));
    }
    ...
    public function modifierAction($id)
    {
        ...
        return $this->render('BenijacoBlogBundle:Blog:modifier.html.twig');
    }
